...
/**
 * Author: Dankyi Solomon Dei
 * Written on: within July/2023
 * Project: EncartaInventory
 **/
...
public class DBConnection {
    ...
    public static Connection getConnection() {
        Connection con;
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/inventory?serverTimezone=UTC&autoReconnect=yes&useSSL=no", "root", "mysqlroot");
